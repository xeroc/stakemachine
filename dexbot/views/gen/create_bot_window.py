...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.strategy_label.raise_()
        self.strategy_input.raise_()
        self.bot_name_label.raise_()
        self.bot_name_input.raise_()
        self.base_asset_label.raise_()
        self.base_asset_input.raise_()
        self.quote_asset_label.raise_()
        self.quote_asset_input.raise_()
