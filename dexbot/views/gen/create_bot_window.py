...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.strategy_label)
        self.strategy_input = QtWidgets.QComboBox(Dialog)
        self.strategy_input.setObjectName("strategy_input")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.strategy_input)
        self.account_label = QtWidgets.QLabel(Dialog)
        self.account_label.setObjectName("account_label")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.account_label)
        self.account_input = QtWidgets.QLineEdit(Dialog)
        self.account_input.setObjectName("account_input")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.account_input)
